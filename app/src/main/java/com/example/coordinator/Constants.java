...
public class Constants {
    ...
    public static final String URL_REPORT_PARTICIPATED_COUNT = ROOT_URL + "UIETApp/Report_Participated_Count.php";
    public static final String URL_UPDATE_EVENTS = ROOT_URL + "UIETApp/UpdateEvents.php";
    public static final String URL_REPORT_STUDENT_VIA_TITLE = ROOT_URL + "UIETApp/Report_Student_Via_Title.php";
}
